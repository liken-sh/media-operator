...
///
/// The window asks for no Wayland app-id. The socket the display claim
/// delivered is what says which screen this client draws on, and the
/// compositor's layout module reads no app-id.
pub fn window(
